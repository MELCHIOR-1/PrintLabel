...
class ApplicationEvents4:
	CLSID = CLSID_Sink = IID('{00020A01-0000-0000-C000-000000000046}')
	coclass_clsid = IID('{000209FF-0000-0000-C000-000000000046}')
	_public_methods_ = [] # For COM Server support
	_dispid_to_func_ = {
		        2 : "OnQuit",
		       32 : "OnProtectedViewWindowBeforeEdit",
		       19 : "OnMailMergeBeforeMerge",
		       20 : "OnMailMergeBeforeRecordMerge",
		        6 : "OnDocumentBeforeClose",
		       22 : "OnMailMergeDataSourceValidate",
		       25 : "OnWindowSize",
		       30 : "OnMailMergeDataSourceValidate2",
		       36 : "OnProtectedViewWindowDeactivate",
		1610678273 : "OnGetTypeInfo",
		       29 : "OnEPostageInsertEx",
		       26 : "OnXMLSelectionChange",
		        4 : "OnDocumentOpen",
		...
		1610612736 : "OnQueryInterface",
		       ...
		       33 : "OnProtectedViewWindowBeforeClose",
		1610678272 : "OnGetTypeInfoCount",
		       34 : "OnProtectedViewWindowSize",
		       13 : "OnWindowBeforeRightClick",
		       31 : "OnProtectedViewWindowOpen",
		       16 : "OnEPostageInsert",
...
#	def OnQuit(self):
#	def OnProtectedViewWindowBeforeEdit(self, PvWindow=defaultNamedNotOptArg, Cancel=defaultNamedNotOptArg):
...
#	def OnMailMergeDataSourceValidate2(self, Doc=defaultNamedNotOptArg, Handled=defaultNamedNotOptArg):
#	def OnProtectedViewWindowDeactivate(self, PvWindow=defaultNamedNotOptArg):
#	def OnGetTypeInfo(self, itinfo=defaultNamedNotOptArg, lcid=defaultNamedNotOptArg, pptinfo=pythoncom.Missing):
#	def OnEPostageInsertEx(self, Doc=defaultNamedNotOptArg, cpDeliveryAddrStart=defaultNamedNotOptArg, cpDeliveryAddrEnd=defaultNamedNotOptArg, cpReturnAddrStart=defaultNamedNotOptArg
#			, cpReturnAddrEnd=defaultNamedNotOptArg, xaWidth=defaultNamedNotOptArg, yaHeight=defaultNamedNotOptArg, bstrPrinterName=defaultNamedNotOptArg, bstrPaperFeed=defaultNamedNotOptArg
#			, fPrint=defaultNamedNotOptArg, fCancel=defaultNamedNotOptArg):
...
#	def OnProtectedViewWindowBeforeClose(self, PvWindow=defaultNamedNotOptArg, CloseReason=defaultNamedNotOptArg, Cancel=defaultNamedNotOptArg):
#	def OnGetTypeInfoCount(self, pctinfo=pythoncom.Missing):
#	def OnProtectedViewWindowSize(self, PvWindow=defaultNamedNotOptArg):
#	def OnWindowBeforeRightClick(self, Sel=defaultNamedNotOptArg, Cancel=defaultNamedNotOptArg):
#	def OnProtectedViewWindowOpen(self, PvWindow=defaultNamedNotOptArg):
...
#	def OnProtectedViewWindowActivate(self, PvWindow=defaultNamedNotOptArg):
...
win32com.client.CLSIDToClass.RegisterCLSID( "{00020A01-0000-0000-C000-000000000046}", ApplicationEvents4 )
