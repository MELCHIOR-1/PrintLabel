...
class constants:
	...
	wdColumnWidthDefault          =2          # from enum WdColumnWidth
	wdColumnWidthNarrow           =1          # from enum WdColumnWidth
	wdColumnWidthWide             =3          # from enum WdColumnWidth
	...
	wdUseWord2010TableStyleRules  =69         # from enum WdCompatibility
	...
	wdWord2013                    =15         # from enum WdCompatibilityMode
	...
	wdContentControlBoundingBox   =0          # from enum WdContentControlAppearance
	wdContentControlHidden        =2          # from enum WdContentControlAppearance
	wdContentControlTags          =1          # from enum WdContentControlAppearance
	...
	wdContentControlLevelCell     =3          # from enum WdContentControlLevel
	wdContentControlLevelInline   =0          # from enum WdContentControlLevel
	wdContentControlLevelParagraph=1          # from enum WdContentControlLevel
	wdContentControlLevelRow      =2          # from enum WdContentControlLevel
	...
	wdContentControlRepeatingSection=9          # from enum WdContentControlType
	...
	wdFieldDisplayBarcode         =99         # from enum WdFieldType
	...
	wdFieldMergeBarcode           =98         # from enum WdFieldType
	...
	wdInBibliography              =42         # from enum WdInformation
	wdInCitation                  =43         # from enum WdInformation
	wdInClipboard                 =38         # from enum WdInformation
	wdInCommentPane               =26         # from enum WdInformation
	wdInContentControl            =46         # from enum WdInformation
	wdInCoverPage                 =41         # from enum WdInformation
	wdInEndnote                   =36         # from enum WdInformation
	wdInFieldCode                 =44         # from enum WdInformation
	wdInFieldResult               =45         # from enum WdInformation
	...
	wdInlineShapeWebVideo         =16         # from enum WdInlineShapeType
	...
	wdPageColorInverse            =2          # from enum WdPageColor
	wdPageColorNone               =0          # from enum WdPageColor
	wdPageColorSepia              =1          # from enum WdPageColor
	...
	wdRDITaskpaneWebExtensions    =17         # from enum WdRemoveDocInfoType
	...
	wdRevisionsMarkupAll          =2          # from enum WdRevisionsMarkup
	wdRevisionsMarkupNone         =0          # from enum WdRevisionsMarkup
	wdRevisionsMarkupSimple       =1          # from enum WdRevisionsMarkup
	...
	wdFormatStrictOpenXMLDocument =24         # from enum WdSaveFormat
	...
	wdTaskPaneProofing            =20         # from enum WdTaskPanes
	wdTaskPaneResearch            =10         # from enum WdTaskPanes
	wdTaskPaneRevPaneFlex         =22         # from enum WdTaskPanes
	...
	wdTaskPaneThesaurus           =23         # from enum WdTaskPanes
	wdTaskPaneTranslate           =3          # from enum WdTaskPanes
	wdTaskPaneXMLDocument         =12         # from enum WdTaskPanes
	wdTaskPaneXMLMapping          =21         # from enum WdTaskPanes
...
CLSIDToClassMap = {}
CLSIDToPackageMap = {
	'{AFAF0C0E-8603-40F6-8FD1-42726CAC21E3}' : u'OMathScrPre',
	'{AE6CE2F5-B9D3-407D-85A8-0F10C63289A4}' : u'Line',
	'{0C1FABE7-F737-406F-9CA3-B07661F9D1A2}' : u'XMLMapping',
	'{CAE36175-3818-4C60-BCBF-0645D51EB33B}' : u'OMathMatCol',
	'{40810760-068A-4486-BEC9-8EA58C7029F5}' : u'Series',
	'{B3A1E8C6-E1CE-4A46-8D12-E017157B03D7}' : u'Legend',
	'{000209FF-0000-0000-C000-000000000046}' : u'Application',
	'{D8779F01-4869-4403-B334-D60C5F9C9175}' : u'OMathAutoCorrectEntry',
	'{00020A00-0001-0000-C000-000000000046}' : u'IApplicationEvents3',
	'{8FEB78F7-35C6-4871-918C-193C3CDD886D}' : u'SeriesCollection',
	'{00020A01-0001-0000-C000-000000000046}' : u'IApplicationEvents4',
	'{5D311669-EA51-11D3-87CC-00105AA31A34}' : u'MappedDataField',
	'{E59544D5-C299-46A0-84C1-C51AB38F9759}' : u'CoAuthor',
	'{BEA85A24-D7DA-4F3D-B58C-ED90FB01D615}' : u'FootnoteOptions',
	'{DF076FDE-8781-4051-A5BC-99F6B7DC04D4}' : u'LegendKey',
	'{36162C62-B59A-4278-AF3D-F2AC1EB999D9}' : u'LeaderLines',
	'{DD947D72-F33C-4198-9BDF-F86181D05E41}' : u'Editor',
	'{02B17CB4-7D55-4B34-B38B-10381433441F}' : u'OMathGroupChar',
	'{F2B60A10-DED5-46FB-A914-3C6F4EBB6451}' : u'SmartTagRecognizers',
	'{E2E0F3A7-204C-40C5-BAA5-290F374FDF5A}' : u'OMathBreaks',
	'{5E9A888C-E5DC-4DCB-8308-3C91FB61E6F4}' : u'SmartTagType',
	'{D040DAF9-6CE4-4BE8-839D-F4538A4301CF}' : u'SoftEdgeFormat',
	'{C1A870A0-850E-4D38-98A7-741CB8C3BCA4}' : u'Points',
	'{9F1DF642-3CCE-4D83-A770-D2634A05D278}' : u'DropLines',
	'{FC9090AF-0DDB-4EC1-86E8-8751F2199F2C}' : u'Gridlines',
	'{67A7EEC5-285D-4024-B071-BD6B33B88547}' : u'OMathRad',
	'{15EBE471-0182-4CCE-98D0-B6614D1C32A1}' : u'SmartTagRecognizer',
	'{1B426348-607D-433C-9216-C5D2BF0EF31F}' : u'OMathMatRows',
	'{FE0971F0-5E60-4985-BCDA-95CB0B8E0308}' : u'XMLSchemaReference',
	'{6FFA84BB-A350-4442-BB53-A43653459A84}' : u'Chart',
	'{65E515D5-F50B-4951-8F38-FA6AC8707387}' : u'OMathBreak',
	'{B923FDE0-F08C-11D3-91B0-00105A0A19FD}' : u'CustomProperty',
	'{B923FDE1-F08C-11D3-91B0-00105A0A19FD}' : u'CustomProperties',
	'{4265ED97-A922-4CA4-8CD8-99684CCA9CDB}' : u'RepeatingSectionItem',
	'{ECFBDB5E-ACD2-4530-AD79-4560B7FF055C}' : u'Category',
	'{2503B6EE-0889-44DF-B920-6D6F9659DEA3}' : u'OMathBorderBox',
	'{99755F80-FE96-4F7D-B636-B8E800E54F44}' : u'CoAuthLock',
	'{54B7061A-D56C-40E5-B85B-58146446C782}' : u'Trendlines',
	'{00020910-0000-0000-C000-000000000046}' : u'Dialogs',
	'{00020911-0000-0000-C000-000000000046}' : u'TableOfAuthorities',
	'{00020912-0000-0000-C000-000000000046}' : u'TablesOfAuthorities',
	'{00020913-0000-0000-C000-000000000046}' : u'TableOfContents',
	'{00020914-0000-0000-C000-000000000046}' : u'TablesOfContents',
	'{00020915-0000-0000-C000-000000000046}' : u'CustomLabel',
	'{00020916-0000-0000-C000-000000000046}' : u'CustomLabels',
	'{00020917-0000-0000-C000-000000000046}' : u'MailingLabel',
	'{00020918-0000-0000-C000-000000000046}' : u'Envelope',
	'{00020919-0000-0000-C000-000000000046}' : u'MailMergeDataField',
	'{0002091A-0000-0000-C000-000000000046}' : u'MailMergeDataFields',
	'{0002091B-0000-0000-C000-000000000046}' : u'MailMergeFieldName',
	'{0002091C-0000-0000-C000-000000000046}' : u'MailMergeFieldNames',
	'{1F998A61-71C6-44C2-A0F2-1D66169B47CB}' : u'OMathEqArray',
	'{0002091E-0000-0000-C000-000000000046}' : u'MailMergeField',
	'{0002091F-0000-0000-C000-000000000046}' : u'MailMergeFields',
	'{00020920-0000-0000-C000-000000000046}' : u'MailMerge',
	'{00020921-0000-0000-C000-000000000046}' : u'TableOfFigures',
	'{44FEE887-6600-41AB-95A5-DE33C605116C}' : u'OMathRecognizedFunctions',
	'{00020923-0000-0000-C000-000000000046}' : u'ListEntry',
	'{00020924-0000-0000-C000-000000000046}' : u'ListEntries',
	'{00020925-0000-0000-C000-000000000046}' : u'DropDown',
	'{00020926-0000-0000-C000-000000000046}' : u'CheckBox',
	'{00020927-0000-0000-C000-000000000046}' : u'TextInput',
	'{00020928-0000-0000-C000-000000000046}' : u'FormField',
	'{00020929-0000-0000-C000-000000000046}' : u'FormFields',
	'{0002092A-0000-0000-C000-000000000046}' : u'Frame',
	'{0002092B-0000-0000-C000-000000000046}' : u'Frames',
	'{0002092C-0000-0000-C000-000000000046}' : u'Style',
	'{0002092D-0000-0000-C000-000000000046}' : u'Styles',
	'{0002092E-0000-0000-C000-000000000046}' : u'Browser',
	'{0002092F-0000-0000-C000-000000000046}' : u'Field',
	'{00020930-0000-0000-C000-000000000046}' : u'Fields',
	'{00020931-0000-0000-C000-000000000046}' : u'LinkFormat',
	'{00020933-0000-0000-C000-000000000046}' : u'OLEFormat',
	'{00020935-0000-0000-C000-000000000046}' : u'System',
	'{00020936-0000-0000-C000-000000000046}' : u'AutoTextEntry',
	'{00020937-0000-0000-C000-000000000046}' : u'AutoTextEntries',
	'{00020939-0000-0000-C000-000000000046}' : u'TextRetrievalMode',
	'{0002093A-0000-0000-C000-000000000046}' : u'Shading',
	'{0002093B-0000-0000-C000-000000000046}' : u'Border',
	'{0002093C-0000-0000-C000-000000000046}' : u'Borders',
	'{0002093D-0000-0000-C000-000000000046}' : u'Comment',
	'{0002093E-0000-0000-C000-000000000046}' : u'Endnote',
	'{0002093F-0000-0000-C000-000000000046}' : u'Footnote',
	'{00020940-0000-0000-C000-000000000046}' : u'Comments',
	'{00020941-0000-0000-C000-000000000046}' : u'Endnotes',
	'{00020942-0000-0000-C000-000000000046}' : u'Footnotes',
	'{00020943-0000-0000-C000-000000000046}' : u'TwoInitialCapsException',
	'{00020944-0000-0000-C000-000000000046}' : u'TwoInitialCapsExceptions',
	'{00020945-0000-0000-C000-000000000046}' : u'FirstLetterException',
	'{00020946-0000-0000-C000-000000000046}' : u'FirstLetterExceptions',
	'{00020947-0000-0000-C000-000000000046}' : u'AutoCorrectEntry',
	'{00020948-0000-0000-C000-000000000046}' : u'AutoCorrectEntries',
	'{00020949-0000-0000-C000-000000000046}' : u'AutoCorrect',
	'{0002094A-0000-0000-C000-000000000046}' : u'Cells',
	'{0002094B-0000-0000-C000-000000000046}' : u'Columns',
	'{0002094C-0000-0000-C000-000000000046}' : u'Rows',
	'{0002094D-0000-0000-C000-000000000046}' : u'Tables',
	'{0002094E-0000-0000-C000-000000000046}' : u'Cell',
	'{0002094F-0000-0000-C000-000000000046}' : u'Column',
	'{00020950-0000-0000-C000-000000000046}' : u'Row',
	'{00020951-0000-0000-C000-000000000046}' : u'Table',
	'{00020952-0000-0000-C000-000000000046}' : u'_Font',
	'{00020953-0000-0000-C000-000000000046}' : u'_ParagraphFormat',
	'{00020954-0000-0000-C000-000000000046}' : u'TabStop',
	'{00020955-0000-0000-C000-000000000046}' : u'TabStops',
	'{00020956-0000-0000-C000-000000000046}' : u'DropCap',
	'{00020957-0000-0000-C000-000000000046}' : u'Paragraph',
	'{00020958-0000-0000-C000-000000000046}' : u'Paragraphs',
	'{00020959-0000-0000-C000-000000000046}' : u'Section',
	'{0002095A-0000-0000-C000-000000000046}' : u'Sections',
	'{0002095B-0000-0000-C000-000000000046}' : u'Sentences',
	'{0002095C-0000-0000-C000-000000000046}' : u'Words',
	'{0002095D-0000-0000-C000-000000000046}' : u'Characters',
	'{0002095E-0000-0000-C000-000000000046}' : u'Range',
	'{0002095F-0000-0000-C000-000000000046}' : u'Panes',
	'{00020960-0000-0000-C000-000000000046}' : u'Pane',
	'{00020961-0000-0000-C000-000000000046}' : u'Windows',
	'{00020962-0000-0000-C000-000000000046}' : u'Window',
	'{00020963-0000-0000-C000-000000000046}' : u'RecentFiles',
	'{00020964-0000-0000-C000-000000000046}' : u'RecentFile',
	'{00020965-0000-0000-C000-000000000046}' : u'Variables',
	'{00020966-0000-0000-C000-000000000046}' : u'Variable',
	'{00020967-0000-0000-C000-000000000046}' : u'Bookmarks',
	'{00020968-0000-0000-C000-000000000046}' : u'Bookmark',
	'{00020969-0000-0000-C000-000000000046}' : u'RoutingSlip',
	'{0002096A-0000-0000-C000-000000000046}' : u'Template',
	'{0002096B-0000-0000-C000-000000000046}' : u'_Document',
	'{0002096C-0000-0000-C000-000000000046}' : u'Documents',
	'{0002096D-0000-0000-C000-000000000046}' : u'Language',
	'{0002096E-0000-0000-C000-000000000046}' : u'Languages',
	'{0002096F-0000-0000-C000-000000000046}' : u'FontNames',
	'{00020970-0000-0000-C000-000000000046}' : u'_Application',
	'{00020971-0000-0000-C000-000000000046}' : u'PageSetup',
	'{00020972-0000-0000-C000-000000000046}' : u'LineNumbering',
	'{00020973-0000-0000-C000-000000000046}' : u'TextColumns',
	'{00020974-0000-0000-C000-000000000046}' : u'TextColumn',
	'{00020975-0000-0000-C000-000000000046}' : u'Selection',
	'{00020976-0000-0000-C000-000000000046}' : u'TablesOfAuthoritiesCategories',
	'{00020977-0000-0000-C000-000000000046}' : u'TableOfAuthoritiesCategory',
	'{00020978-0000-0000-C000-000000000046}' : u'CaptionLabels',
	'{00020979-0000-0000-C000-000000000046}' : u'CaptionLabel',
	'{0002097A-0000-0000-C000-000000000046}' : u'AutoCaptions',
	'{0002097B-0000-0000-C000-000000000046}' : u'AutoCaption',
	'{0002097C-0000-0000-C000-000000000046}' : u'Indexes',
	'{0002097D-0000-0000-C000-000000000046}' : u'Index',
	'{0002097E-0000-0000-C000-000000000046}' : u'AddIn',
	'{0002097F-0000-0000-C000-000000000046}' : u'AddIns',
	'{00020980-0000-0000-C000-000000000046}' : u'Revisions',
	'{00020981-0000-0000-C000-000000000046}' : u'Revision',
	'{00020982-0000-0000-C000-000000000046}' : u'Task',
	'{00020983-0000-0000-C000-000000000046}' : u'Tasks',
	'{00020984-0000-0000-C000-000000000046}' : u'HeadersFooters',
	'{00020985-0000-0000-C000-000000000046}' : u'HeaderFooter',
	'{00020986-0000-0000-C000-000000000046}' : u'PageNumbers',
	'{00020987-0000-0000-C000-000000000046}' : u'PageNumber',
	'{00020988-0000-0000-C000-000000000046}' : u'Subdocuments',
	'{00020989-0000-0000-C000-000000000046}' : u'Subdocument',
	'{0002098A-0000-0000-C000-000000000046}' : u'HeadingStyles',
	'{0002098B-0000-0000-C000-000000000046}' : u'HeadingStyle',
	'{0002098C-0000-0000-C000-000000000046}' : u'StoryRanges',
	'{0002098D-0000-0000-C000-000000000046}' : u'ListLevel',
	'{0002098E-0000-0000-C000-000000000046}' : u'ListLevels',
	'{0002098F-0000-0000-C000-000000000046}' : u'ListTemplate',
	'{00020990-0000-0000-C000-000000000046}' : u'ListTemplates',
	'{00020991-0000-0000-C000-000000000046}' : u'ListParagraphs',
	'{00020992-0000-0000-C000-000000000046}' : u'List',
	'{00020993-0000-0000-C000-000000000046}' : u'Lists',
	'{00020994-0000-0000-C000-000000000046}' : u'ListGallery',
	'{00020995-0000-0000-C000-000000000046}' : u'ListGalleries',
	'{00020996-0000-0000-C000-000000000046}' : u'KeyBindings',
	'{00020997-0000-0000-C000-000000000046}' : u'KeysBoundTo',
	'{00020998-0000-0000-C000-000000000046}' : u'KeyBinding',
	'{00020999-0000-0000-C000-000000000046}' : u'FileConverter',
	'{0002099A-0000-0000-C000-000000000046}' : u'FileConverters',
	'{0002099B-0000-0000-C000-000000000046}' : u'SynonymInfo',
	'{0002099C-0000-0000-C000-000000000046}' : u'Hyperlinks',
	'{0002099D-0000-0000-C000-000000000046}' : u'Hyperlink',
	'{0002099F-0000-0000-C000-000000000046}' : u'Shapes',
	'{000209A0-0000-0000-C000-000000000046}' : u'Shape',
	'{000209A1-0000-0000-C000-000000000046}' : u'_LetterContent',
	'{000209A2-0000-0000-C000-000000000046}' : u'Templates',
	'{000209A4-0000-0000-C000-000000000046}' : u'_OLEControl',
	'{000209A5-0000-0000-C000-000000000046}' : u'View',
	'{000209A6-0000-0000-C000-000000000046}' : u'Zoom',
	'{000209A7-0000-0000-C000-000000000046}' : u'Zooms',
	'{000209A8-0000-0000-C000-000000000046}' : u'InlineShape',
	'{000209A9-0000-0000-C000-000000000046}' : u'InlineShapes',
	'{000209AA-0000-0000-C000-000000000046}' : u'SpellingSuggestions',
	'{000209AB-0000-0000-C000-000000000046}' : u'SpellingSuggestion',
	'{000209AC-0000-0000-C000-000000000046}' : u'Dictionaries',
	'{000209AD-0000-0000-C000-000000000046}' : u'Dictionary',
	'{000209AE-0000-0000-C000-000000000046}' : u'ReadabilityStatistics',
	'{000209AF-0000-0000-C000-000000000046}' : u'ReadabilityStatistic',
	'{000209B0-0000-0000-C000-000000000046}' : u'Find',
	'{000209B1-0000-0000-C000-000000000046}' : u'Replacement',
	'{000209B2-0000-0000-C000-000000000046}' : u'TextFrame',
	'{000209B3-0000-0000-C000-000000000046}' : u'Versions',
	'{000209B4-0000-0000-C000-000000000046}' : u'Version',
	'{000209B5-0000-0000-C000-000000000046}' : u'ShapeRange',
	'{000209B6-0000-0000-C000-000000000046}' : u'GroupShapes',
	'{000209B7-0000-0000-C000-000000000046}' : u'Options',
	'{000209B8-0000-0000-C000-000000000046}' : u'Dialog',
	'{000209B9-0000-0000-C000-000000000046}' : u'_Global',
	'{000209BA-0000-0000-C000-000000000046}' : u'MailMessage',
	'{000209BB-0000-0000-C000-000000000046}' : u'ProofreadingErrors',
	'{000209BD-0000-0000-C000-000000000046}' : u'Mailer',
	'{000209C0-0000-0000-C000-000000000046}' : u'ListFormat',
	'{000209C3-0000-0000-C000-000000000046}' : u'WrapFormat',
	'{000209C4-0000-0000-C000-000000000046}' : u'Adjustments',
	'{000209C5-0000-0000-C000-000000000046}' : u'CalloutFormat',
	'{000209C6-0000-0000-C000-000000000046}' : u'ColorFormat',
	'{000209C7-0000-0000-C000-000000000046}' : u'ConnectorFormat',
	'{000209C8-0000-0000-C000-000000000046}' : u'FillFormat',
	'{000209C9-0000-0000-C000-000000000046}' : u'FreeformBuilder',
	'{000209CA-0000-0000-C000-000000000046}' : u'LineFormat',
	'{000209CB-0000-0000-C000-000000000046}' : u'PictureFormat',
	'{000209CC-0000-0000-C000-000000000046}' : u'ShadowFormat',
	'{000209CD-0000-0000-C000-000000000046}' : u'ShapeNode',
	'{000209CE-0000-0000-C000-000000000046}' : u'ShapeNodes',
	'{000209CF-0000-0000-C000-000000000046}' : u'TextEffectFormat',
	'{000209D0-0000-0000-C000-000000000046}' : u'ThreeDFormat',
	'{000209D1-0000-0000-C000-000000000046}' : u'HangulAndAlphabetExceptions',
	'{000209D2-0000-0000-C000-000000000046}' : u'HangulAndAlphabetException',
	'{000209D7-0000-0000-C000-000000000046}' : u'EmailAuthor',
	'{000209DB-0000-0000-C000-000000000046}' : u'EmailOptions',
	'{000209DC-0000-0000-C000-000000000046}' : u'EmailSignature',
	'{000209DD-0000-0000-C000-000000000046}' : u'Email',
	'{000209DE-0000-0000-C000-000000000046}' : u'HorizontalLineFormat',
	'{000209DF-0000-0000-C000-000000000046}' : u'OtherCorrectionsExceptions',
	'{000209E0-0000-0000-C000-000000000046}' : u'HangulHanjaConversionDictionaries',
	'{000209E1-0000-0000-C000-000000000046}' : u'OtherCorrectionsException',
	'{000209E2-0000-0000-C000-000000000046}' : u'Frameset',
	'{000209E3-0000-0000-C000-000000000046}' : u'DefaultWebOptions',
	'{000209E4-0000-0000-C000-000000000046}' : u'WebOptions',
	'{000209E5-0000-0000-C000-000000000046}' : u'EmailSignatureEntries',
	'{000209E6-0000-0000-C000-000000000046}' : u'EmailSignatureEntry',
	'{000209E7-0000-0000-C000-000000000046}' : u'HTMLDivision',
	'{000209E8-0000-0000-C000-000000000046}' : u'HTMLDivisions',
	'{000209E9-0000-0000-C000-000000000046}' : u'DiagramNode',
	'{000209EA-0000-0000-C000-000000000046}' : u'DiagramNodeChildren',
	'{000209EB-0000-0000-C000-000000000046}' : u'DiagramNodes',
	'{000209EC-0000-0000-C000-000000000046}' : u'Diagram',
	'{000209ED-0000-0000-C000-000000000046}' : u'SmartTag',
	'{000209EE-0000-0000-C000-000000000046}' : u'SmartTags',
	'{000209EF-0000-0000-C000-000000000046}' : u'StyleSheet',
	'{000209F0-0000-0000-C000-000000000046}' : u'Global',
	'{000209F1-0000-0000-C000-000000000046}' : u'LetterContent',
	'{000209F2-0000-0000-C000-000000000046}' : u'OLEControl',
	'{000209F3-0000-0000-C000-000000000046}' : u'OCXEvents',
	'{000209F4-0000-0000-C000-000000000046}' : u'ParagraphFormat',
	'{000209F5-0000-0000-C000-000000000046}' : u'Font',
	'{000209F6-0000-0000-C000-000000000046}' : u'DocumentEvents',
	'{000209F7-0000-0000-C000-000000000046}' : u'ApplicationEvents',
	'{000209F7-0001-0000-C000-000000000046}' : u'IApplicationEvents',
	'{000209FE-0000-0000-C000-000000000046}' : u'ApplicationEvents2',
	'{000209FE-0001-0000-C000-000000000046}' : u'IApplicationEvents2',
	'{00020A00-0000-0000-C000-000000000046}' : u'ApplicationEvents3',
	'{00020A01-0000-0000-C000-000000000046}' : u'ApplicationEvents4',
	'{00020A02-0000-0000-C000-000000000046}' : u'DocumentEvents2',
	'{C94688A6-A2A7-4133-A26D-726CD569D5F3}' : u'OMathDelim',
	'{07B7CC7E-E66C-11D3-9454-00105AA31A08}' : u'StyleSheets',
	'{354AB591-A217-48B4-99E4-14F58F15667D}' : u'Axes',
	'{B9F1A4E2-0D0A-43B7-8495-139E7ACBD840}' : u'TaskPane',
	'{BFD3FC23-F763-4FF8-826E-1AFBF598A4E7}' : u'BuildingBlock',
	'{F743EDD0-9B97-4B09-89CC-77BE19B51481}' : u'ProtectedViewWindow',
	'{0D951ADF-10A6-4C9B-BCD9-0FB8CBAD9A87}' : u'OMathFunc',
	'{1FD94DF1-3569-4465-94FF-E8B22D28EEB0}' : u'DataLabel',
	'{39709229-56A0-4E29-9112-B31DD067EBFD}' : u'BuildingBlockEntries',
	'{0002091D-0000-0000-C000-000000000046}' : u'MailMergeDataSource',
	'{16BE9309-D708-4322-BB1A-B056F58D17EA}' : u'Breaks',
	'{B7564E97-0519-4C68-B400-3803E7C63242}' : u'TableStyle',
	'{00020922-0000-0000-C000-000000000046}' : u'TablesOfFigures',
	'{30225CFC-5A71-4FE6-B527-90A52C54AE77}' : u'CoAuthUpdates',
	'{5C04BD93-2F3F-4668-918D-9738EC901039}' : u'OMathRecognizedFunction',
	'{D8252C5E-EB9F-4D74-AA72-C178B128FAC4}' : u'DataLabels',
	'{0C6FA8CA-E65F-4FC7-AB8F-20729EECBB14}' : u'ContentControlListEntry',
	'{DB8E3072-E106-4453-8E7C-53056F1D30DC}' : u'SmartTagTypes',
	'{BF043168-F4DE-4E7C-B206-741A8B3EF71A}' : u'EndnoteOptions',
	'{3834F60F-EE8C-455D-A441-D766675D6D3B}' : u'Bibliography',
	'{04124C2D-039D-4442-9C68-8FA38D11DDD6}' : u'CategoryCollection',
	'{194F8476-B79D-4572-A609-294207DE77C1}' : u'ErrorBars',
	'{5DAA8BB6-054E-48F6-BEAC-EAAD02BE0CC7}' : u'OMathMatRow',
	'{E6AAEC05-E543-4085-BA92-9BF7D2474F5C}' : u'TaskPanes',
	'{8245795B-9AED-4943-A16D-E586ED8180D1}' : u'OMathArgs',
	'{53FACA33-DB22-473F-BB51-96C2C86C9304}' : u'RepeatingSectionItemColl',
	'{65DF9F31-B1E3-4651-87E8-51D55F302161}' : u'CoAuthoring',
	'{C4A02049-024C-4273-8934-E48CC21479A9}' : u'LegendEntry',
	'{84A6A663-AEF4-4FCD-83FD-9BB707F157CA}' : u'DownBars',
	'{8B0E45DB-3A7B-42EE-9D17-A92AF69B79C1}' : u'AxisTitle',
	'{B67DE22C-BC01-4A73-A99B-070D1B5A795D}' : u'Broadcast',
	'{74DE9576-8E99-4E28-912B-CB30747C60CE}' : u'OMathLimLow',
	'{7D0F7985-68D9-4D93-91CB-8109280E76CC}' : u'Rectangles',
	'{5D7F6C15-36CE-44CC-9692-5A1F8B8C906D}' : u'SeriesLines',
	'{79635BF1-BD1D-4B3F-A520-C1106F1AAAD8}' : u'Break',
	'{B5828B50-0E3D-448A-962D-A40702A5868D}' : u'BuildingBlockTypes',
	'{256B6ABA-6A38-4D39-971C-91FDA9922814}' : u'CoAuthors',
	'{A2E94180-7564-4D97-806B-BBC0D0A1350C}' : u'Walls',
	'{C75AD98A-74E9-49FE-8BF1-544839CC08A5}' : u'ChartArea',
	'{6F9D1F68-06F7-49EF-8902-185E54EB5E87}' : u'OMathAutoCorrect',
	'{56AFD330-440C-4F4C-A39C-ED306D084D5F}' : u'PlotArea',
	'{FF06FEF2-DA89-41C0-A0A8-5CD434E210AD}' : u'ChartCharacters',
	'{D523C26B-7278-4FA9-AA0B-0827DC8B41CE}' : u'RevisionsFilter',
	'{DFB6AA6C-1068-420F-969D-01280FCC1630}' : u'SmartTagAction',
	'{C774F5EA-A539-4284-A1BE-30AEC052D899}' : u'XSLTransforms',
	'{91807402-6C6F-47CD-B8FA-C42FEE8EE924}' : u'Pages',
	'{7A1BCE11-5783-4C7D-BD02-F3D84AB40E7F}' : u'HiLoLines',
	'{F1B14F40-5C32-4C8C-B5B2-DE537BB6B89D}' : u'GlowFormat',
	'{C6D50987-25D7-408A-BFF2-90BF86A24E93}' : u'BuildingBlocks',
	'{A87E00E9-3AC3-4B53-ABE3-7379653D0E82}' : u'XMLChildNodeSuggestion',
	'{C04865A3-9F8A-486C-BB58-B4C3E6563136}' : u'DisplayUnitLabel',
	'{B66D3C1A-4541-4961-B35B-A353C03F6A99}' : u'ChartFormat',
	'{12DCDC9A-5418-48A3-BBE6-EB57BAE275E8}' : u'Reviewers',
	'{F01943FF-1985-445E-8602-8FB8F39CCA75}' : u'ReflectionFormat',
	'{396F9073-F9FD-11D3-8EA0-0050049A1A01}' : u'CanvasShapes',
	'{DB77D541-85C3-42E8-8649-AFBD7CF87866}' : u'OMathPhantom',
	'{E598E358-2852-42D4-8775-160BD91B7244}' : u'UndoRecord',
	'{C1AD33E4-F088-40A9-9D2F-D94017D115C4}' : u'ChartTitle',
	'{47CEF4AE-DC32-4220-8AA5-19CCC0E6633A}' : u'Reviewer',
	'{FC9086C6-0287-4997-B2E1-816C334A22F8}' : u'OMathLimUpp',
	'{FD0A74E8-C719-49F6-BA1B-F6D9839D1AB9}' : u'ProtectedViewWindows',
	'{AE6D45E5-981E-4547-8752-674BB55420A5}' : u'Corners',
	'{799A6814-EA41-11D3-87CC-00105AA31A34}' : u'MappedDataFields',
	'{CEBD4184-4E6D-4FC6-A42D-2142B1B76AF5}' : u'OMathNary',
	'{18CD5EC8-8B7B-42C8-992A-2A407468642C}' : u'OMathAutoCorrectEntries',
	'{1498F56D-ED33-41F9-B37B-EF30E50B08AC}' : u'ConditionalStyle',
	'{8A342FA0-5831-4B5E-82E1-003D0A0C635D}' : u'Point',
	'{98DFBD12-96CB-4F07-90EA-749FF1D6B89D}' : u'OMathScrSub',
	'{E2E8A400-0615-427D-ADCC-CAD39FFEBD42}' : u'Lines',
	'{B184502B-587A-4C6A-8DC4-ECE4354883C6}' : u'Interior',
	'{CDE12CD8-767B-4757-8A31-13029A086305}' : u'SmartTagActions',
	'{00020906-0000-0000-C000-000000000046}' : u'Document',
	'{C2B83A65-B061-4469-83B6-8877437CB8A0}' : u'Conflicts',
	'{817F99FA-CCC4-4971-8E9D-1238F735AAFF}' : u'BuildingBlockType',
	'{09760240-0B89-49F7-A79D-479F24723F56}' : u'XMLNode',
	'{B6511068-70BF-4751-A741-55C1D41AD96F}' : u'LegendEntries',
	'{DCE9F2C4-4C02-43BA-840E-B4276550EF79}' : u'DataTable',
	'{D0A95726-678A-4B9D-8103-1E2B86735AE7}' : u'OMathScrSup',
	'{DFF99AC2-CD2A-43AD-91B1-A2BE40BC7146}' : u'CoAuthLocks',
	'{E3124493-7D6A-410F-9A48-CC822C033CEC}' : u'XSLTransform',
	'{FA02A26B-6550-45C5-B6F0-80E757CD3482}' : u'Sources',
	'{B140A023-4850-4DA6-BC5F-CC459C4507BC}' : u'XMLNamespace',
	'{DC489AD4-23C4-4F4B-990F-45A51C7C0C4F}' : u'OMathScrSubSup',
	'{6215E4B1-545A-406E-9824-0A5B5AC8AD21}' : u'Conflict',
	'{CDB0FF41-E862-47BB-AE77-3FA7B1AE3189}' : u'ChartFont',
	'{54F46DC4-F6A6-48CC-BD66-46C1DDEADD22}' : u'ContentControlListEntries',
	'{86905AC9-33F3-4A88-96C8-B289B0390BCA}' : u'UpBars',
	'{86488FB4-9633-4C93-8057-FC1FA7A847AE}' : u'ChartGroup',
	'{DE63B5AC-CA4F-46FE-9184-A5719AB9ED5B}' : u'XMLChildNodeSuggestions',
	'{AED7E08C-14F0-4F33-921D-4C5353137BF6}' : u'Editors',
	'{F08B45F1-8F23-4156-9D63-1820C0ED229A}' : u'OMathBar',
	'{7EBC66BD-F788-42C3-91F4-E8C841A69005}' : u'Axis',
	'{EE95AFE3-3026-4172-B078-0E79DAB5CC3D}' : u'ContentControl',
	'{4DACC469-630B-457E-9C8F-08158D57FC7C}' : u'FullSeriesCollection',
	'{DD8F80B8-9B80-4E89-9BEC-F12DF35E43B3}' : u'ChartColorFormat',
	'{F1F37152-1DB1-4901-AD9A-C740F99464B4}' : u'OMathFunction',
	'{935D59F5-E365-4F92-B7F5-1C499A63ECA8}' : u'TickLabels',
	'{7E64D2BE-2818-48CB-8F8A-CC7B61D9E860}' : u'Floor',
	'{E4442A83-F623-459C-8E95-8BFB44DCF23A}' : u'OMath',
	'{842C37FE-C76F-4B2B-9B60-C408CB5E838E}' : u'OMathBox',
	'{AB0D33A3-C9EA-485B-9443-4C1BB3656CEA}' : u'ChartBorder',
	'{4A6AE865-199D-4EA3-9F6B-125BD9C40EDF}' : u'Source',
	'{6E47678B-A879-4E56-8698-3B7CF169FAD4}' : u'Categories',
	'{E6AAEC05-E543-4085-BA92-9BF7D2474F51}' : u'Research',
	'{EFC71F9C-7F42-4CD4-A7A7-970D7A48CD27}' : u'OMathMatCols',
	'{9E6B5EC5-E8E4-40AF-9540-6203F71E2823}' : u'CoAuthUpdate',
	'{352840A9-AF7D-4CA4-87FC-21C68FDAB3E4}' : u'Page',
	'{3E061A7E-67AD-4EAA-BC1E-55057D5E596F}' : u'OMathMat',
	'{804CD967-F83B-432D-9446-C61A45CFEFF0}' : u'ContentControls',
	'{873E774B-926A-4CB1-878D-635A45187595}' : u'OMaths',
	'{F8DDB497-CA6C-4711-9BA4-2718FA3BB6FE}' : u'ChartGroups',
	'{D36C1F42-7044-4B9E-9CA3-85919454DB04}' : u'XMLNodes',
	'{656BBED7-E82D-4B0A-8F97-EC742BA11FFA}' : u'XMLNamespaces',
	'{F258DE05-C41B-4C33-A778-F0D3F98CEEB3}' : u'OMathAcc',
	'{356B06EC-4908-42A4-81FC-4B5A51F3483B}' : u'XMLSchemaReferences',
	'{50209974-BA32-4A03-8FA6-BAC56CC056FD}' : u'OMathFrac',
	'{ADD4EDF3-2F33-4734-9CE6-D476097C5ADA}' : u'Rectangle',
	'{4A304B59-31FF-42DD-B436-7FC9C5DB7559}' : u'ChartData',
	'{5A90588C-C066-4BD4-8FE5-722454A15553}' : u'ChartCategory',
	'{91C46192-3124-4346-A815-10B8873F5A06}' : u'Trendline',
	'{497142A4-16FD-42C6-BC58-15D89345FC21}' : u'OMathFunctions',
	'{F152D349-7D20-4C01-A42B-2D6DE4F3891C}' : u'ChartFillFormat',
}
VTablesToClassMap = {}
VTablesToPackageMap = {
	...
	'{4265ED97-A922-4CA4-8CD8-99684CCA9CDB}' : 'RepeatingSectionItem',
	...
	'{04124C2D-039D-4442-9C68-8FA38D11DDD6}' : 'CategoryCollection',
	...
	'{53FACA33-DB22-473F-BB51-96C2C86C9304}' : 'RepeatingSectionItemColl',
	...
	'{B67DE22C-BC01-4A73-A99B-070D1B5A795D}' : 'Broadcast',
	...
	'{D523C26B-7278-4FA9-AA0B-0827DC8B41CE}' : 'RevisionsFilter',
	...
	'{4DACC469-630B-457E-9C8F-08158D57FC7C}' : 'FullSeriesCollection',
	...
	'{5A90588C-C066-4BD4-8FE5-722454A15553}' : 'ChartCategory',
...
NamesToIIDMap = {
	...
	'RepeatingSectionItemColl' : '{53FACA33-DB22-473F-BB51-96C2C86C9304}',
	...
	'Broadcast' : '{B67DE22C-BC01-4A73-A99B-070D1B5A795D}',
	...
	'FullSeriesCollection' : '{4DACC469-630B-457E-9C8F-08158D57FC7C}',
	...
	'ChartCategory' : '{5A90588C-C066-4BD4-8FE5-722454A15553}',
	...
	'RevisionsFilter' : '{D523C26B-7278-4FA9-AA0B-0827DC8B41CE}',
	...
	'CategoryCollection' : '{04124C2D-039D-4442-9C68-8FA38D11DDD6}',
	...
	'RepeatingSectionItem' : '{4265ED97-A922-4CA4-8CD8-99684CCA9CDB}',
